...
// startup, both roles) and its author (SharedConfigPublisher, generating
// it from the in-code option defaults - ADR-120; formerly hand-edited
// and uploaded via az storage blob upload) need to agree on where it lives.
