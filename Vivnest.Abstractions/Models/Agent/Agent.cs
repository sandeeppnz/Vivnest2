...
public class Agent : ISiteScoped
{
    ...
    public Enums.AgentStatus Status { get; private set; }

    public string FirmwareVersion { get; private set; } = null!;

    public Enums.AgentType Type { get; private set; }
    ...
    public void SetStatus(Enums.AgentStatus status)
    {
        Status = status;
        UpdatedUtc = DateTime.UtcNow;
    }
