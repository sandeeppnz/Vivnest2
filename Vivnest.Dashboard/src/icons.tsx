...
function PuzzleSvgIcon(props: IconProps) {
  return (
    <Svg {...props}>
...
function LinkSvgIcon(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M9 15l6 -6" />
...
// Theme toggle (header/sidebar): each icon shows the theme a click
// SWITCHES TO, not the current one - sun in dark mode, moon in light.
...
export function PuzzleIcon(props: IconProps) {
  return <PuzzleSvgIcon {...props} />;
}

export function LinkIcon(props: IconProps) {
  return <LinkSvgIcon {...props} />;
}
